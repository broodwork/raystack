...
class Settings(BaseModel):
    ...
    secret_key: str
    debug: bool
    youmoney_client_id: Union[str, None] = None  # Добавьте эти поля, если они нужны
    youmoney_redirect_url: Union[str, None] = None
    youmoney_client_secret: Union[str, None] = None
    youmoney_access_token: Union[str, None] = None
    youmoney_wallet_number: Union[str, None] = None

    # Config removed for BaseModel compatibility
